export const meta = {
	...
	"summary": "",
	"date": "2022-06-29",
	"sections": ["Introduction", "The Physics", "RK4 Method", "Drawing", "Closing Notes"]
}
...
amount, and so on. We can now see where the halway point would be for each of these variables:
$$
