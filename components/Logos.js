...
const Logos = () => (
  <ul className={logosStyle.logos}>
    ...
    <li> <a href="https://www.linkedin.com/in/aryanabed/" target='_blank'> <div className={logosStyle.container}> <Image src="/images/LinkedInLogo.webp" layout="fill" alt="LinkedIn" /> </div> </a> </li>
  </ul>
);
